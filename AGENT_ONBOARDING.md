...
- **ERPNext duplicate parties:** a failed "does this customer exist?" lookup was read as "no" and created "X - 1". It now fails and the outbox retries (`ErpNextPartyUpsertTests`).
