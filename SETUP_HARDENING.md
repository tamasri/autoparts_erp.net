...
**Production data to review (owner decision, 2026-09-24)**
- Until 2026-09-24 the API inserted demo data on first start in every environment. If the VPS database has customers WS-0001…WS-0004, RT-0001, WH-0001 ("ورشة أبو علي للسيارات", "معرض الوفاء للتجزئة", …), items AIR-FILT-TOY-001 etc. and invoices dated around its first start, they are samples, not business data, and may also be in ERPNext. Decide whether to remove them (take a backup first); nothing is deleted automatically.
